...
public class GUILaberinto extends javax.swing.JFrame {
    ...
    public GUILaberinto() {
        ...
        // Ubicar en la esquina superior izquierda
            ...
            if (countDown <= 10) {
                txtTime.setForeground(Color.RED); // Cambiar a rojo cuando queden 10 segundos
                 for (java.awt.Window window : java.awt.Window.getWindows()) {
                     //Esta parte del metodo sirve para detectar que otra ventana que no sea la actual y cuando esta se abra se detenga el tiempo
    ...
    private void initComponents() {
        ...
        txtTime.setBounds(170, 60, 40, 20);
